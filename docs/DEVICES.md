...
| 72 | Trigger board 2 | AVR HMTL module | Lightbringer vehicle: 4 accumulator poofs. Verified 2026-08-28: HMTL_Module v29 (current), bus round-trip to FC 128 ✓; reflashed env:mini (was env:nano — its STARTUP_SPARKLE made 72 sparkle at boot; boots dark now, as intended) |
